...
use Cai\WebBundle\Entity\Menu;
use Cai\WebBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    {
        $menu = new Menu();
        $form = $this->createForm('Cai\WebBundle\Form\MenuType', $menu);
    ...
    {
        $deleteForm = $this->createDeleteForm($menu);
        $editForm = $this->createForm('Cai\WebBundle\Form\MenuType', $menu);
